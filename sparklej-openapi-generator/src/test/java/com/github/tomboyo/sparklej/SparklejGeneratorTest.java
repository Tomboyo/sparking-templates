 ...
 * 1) Set a break point in SparklejGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class SparklejGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("sparklej") // use this codegen library
              .setInputSpec("https://petstore3.swagger.io/api/v3/openapi.yaml")
              .setOutputDir("target/testout/petstorev3"); // output directory
